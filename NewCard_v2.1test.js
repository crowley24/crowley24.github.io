(function () {  
  ...
  /* Почергова анімація іконок якості */
  ...
  .cas-animated .cas-quality-item:nth-child(3) { transition-delay: 1.15s; }
  .cas-animated .cas-quality-item:nth-child(4) { transition-delay: 1.25s; }

  .cas-animated .cas-description { transition-delay: 1.35s; }
  
  /* Анімація кнопок */
  .cas-animated .full-start-new__buttons .button--play { transition-delay: 1.5s; }
  .cas-animated .full-start-new__buttons .button--book { transition-delay: 1.6s; }
  ...
  .left-title .full-start-new__buttons .full-start__button.focus {
      background: #fff !important; color: #000 !important; transform: scale(1.08) translateY(-3px) !important;
  }
  ...
  /* Системні блоки приховані, власні кнопки відображаються */
              ...
              <div class="full-start-new__right">    
                  <div class="left-title__content">    
                     ...
                     <div class="cas-studios-row" style="margin-bottom: var(--cas-blocks-gap); display: flex; gap: 15px; align-items: center;"></div>  
                      ...
                      <div class="rating--modss hide"></div>
                      <div class="buttons--container hide"></div>
