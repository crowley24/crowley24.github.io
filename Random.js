...
(function () {  
 ...
 function addMenuItem(){  
  ...
  var $btn=$('<li class="menu__item selector" data-id="'+MENU_ID+'"><div class="menu__ico"><svg height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="cubeTop" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#f8f8f8;stop-opacity:1"/><stop offset="100%" style="stop-color:#d0d0d0;stop-opacity:1"/></linearGradient><linearGradient id="cubeLeft" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#e0e0e0;stop-opacity:1"/><stop offset="100%" style="stop-color:#b0b0b0;stop-opacity:1"/></linearGradient><linearGradient id="cubeRight" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#c8c8c8;stop-opacity:1"/><stop offset="100%" style="stop-color:#989898;stop-opacity:1"/></linearGradient><filter id="shadow" x="-50%" y="-50%" width="200%" height="200%"><feGaussianBlur in="SourceAlpha" stdDeviation="1.5"/><feOffset dx="1" dy="2" result="offsetblur"/><feComponentTransfer><feFuncA type="linear" slope="0.4"/></feComponentTransfer><feMerge><feMergeNode/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs><g filter="url(#shadow)"><path d="M12 4 L20 8 L20 16 L12 20 L4 16 L4 8 Z" fill="url(#cubeTop)" stroke="#888" stroke-width="0.8"/><path d="M4 8 L12 12 L12 20 L4 16 Z" fill="url(#cubeLeft)" stroke="#888" stroke-width="0.8"/><path d="M12 12 L20 8 L20 16 L12 20 Z" fill="url(#cubeRight)" stroke="#888" stroke-width="0.8"/><circle cx="12" cy="10" r="1.2" fill="#333"/><circle cx="8" cy="14" r="1.2" fill="#333"/><circle cx="16" cy="14" r="1.2" fill="#333"/></g></svg></div><div class="menu__text">'+title+'</div></li>');  
