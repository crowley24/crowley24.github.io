...
(function () {  
 ...
 function addMenuItem(){  
  ...
  var $btn=$('<li class="menu__item selector" data-id="'+MENU_ID+'"><div class="menu__ico"><svg height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="cubeGradient" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#ffffff;stop-opacity:0.8"/><stop offset="100%" style="stop-color:#e0e0e0;stop-opacity:1"/></linearGradient><filter id="shadow" x="-50%" y="-50%" width="200%" height="200%"><feGaussianBlur in="SourceAlpha" stdDeviation="1"/><feOffset dx="1" dy="1" result="offsetblur"/><feComponentTransfer><feFuncA type="linear" slope="0.3"/></feComponentTransfer><feMerge><feMergeNode/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs><g filter="url(#shadow)"><rect x="2" y="2" width="8" height="8" rx="1" fill="url(#cubeGradient)" stroke="#888" stroke-width="0.5"/><rect x="4" y="4" width="1" height="1" rx="0.5" fill="#333"/><rect x="7" y="7" width="1" height="1" rx="0.5" fill="#333"/><rect x="14" y="2" width="8" height="8" rx="1" fill="url(#cubeGradient)" stroke="#888" stroke-width="0.5"/><rect x="16" y="4" width="1" height="1" rx="0.5" fill="#333"/><rect x="19" y="4" width="1" height="1" rx="0.5" fill="#333"/><rect x="16" y="7" width="1" height="1" rx="0.5" fill="#333"/><rect x="19" y="7" width="1" height="1" rx="0.5" fill="#333"/><rect x="2" y="14" width="8" height="8" rx="1" fill="url(#cubeGradient)" stroke="#888" stroke-width="0.5"/><rect x="4" y="16" width="1" height="1" rx="0.5" fill="#333"/><rect x="7" y="16" width="1" height="1" rx="0.5" fill="#333"/><rect x="4" y="19" width="1" height="1" rx="0.5" fill="#333"/><rect x="7" y="19" width="1" height="1" rx="0.5" fill="#333"/><rect x="14" y="14" width="8" height="8" rx="1" fill="url(#cubeGradient)" stroke="#888" stroke-width="0.5"/><rect x="16" y="16" width="1" height="1" rx="0.5" fill="#333"/><rect x="19" y="19" width="1" height="1" rx="0.5" fill="#333"/></g></svg></div><div class="menu__text">'+title+'</div></li>');  
