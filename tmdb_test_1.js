(function () {  
    ...
    function addSettings() {  
        ...
        collectionsConfig.forEach(function(cfg) {    
            ...
            // Тип постерів (ВИПРАВЛЕНО: статичні значення замість перекладів)    
            Lampa.SettingsApi.addParam({    
                component: 'tmdb_mod',    
                param: {     
                ...
                field: { name: 'Тип постерів: ' + translatedName, description: 'Оберіть орієнтацію постерів для цієї добірки' },    
                onChange: function (value) {    
