(function() {  
    ...
    // Функція показу налаштувань FoxStudio (вирішення проблеми з порожнім екраном)  
    function showFoxStudioSettings() {  
        // Створюємо контейнер для налаштувань  
        var settingsBody = $('<div class="settings-body"></div>');  
        ...
        settingsBody.append(foxstudio_interface);  
        settingsBody.append(necardify_setting);  
        settingsBody.append(logo_setting);  
        ...
        // Додаємо наші налаштування до створеного екрана  
        setTimeout(function() {  
    ...
    function init() {  
        ...
        Lampa.Settings.listener.follow('open', function(e) {  
            if (e.name === 'main') {  
                // Прикріплюємо обробник кліку до нашого елемента  
