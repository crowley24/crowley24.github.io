(function () {  
  ...
  function getBest(results) {  
    var best = { resolution: null, hdr: false, dolbyVision: false, audio: null, dub: false, ukrainian: false };  
    ...
    for (var i = 0; i < limit; i++) {  
      ...
      // Перевірка на український дубляж  
      if (title.indexOf('укр') >= 0 || title.indexOf('ukr') >= 0 || title.indexOf('український') >= 0 || title.indexOf('ukrainian') >= 0) {  
        best.ukrainian = true;  
      }  
