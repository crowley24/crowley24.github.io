(function () {  
    ...
    var LOGIC_DESCRIPTIONS = {  
        strict: {  
            ...
            description: 'Показує фільми/серіали, що містять ВСІ обрані жанри'  
        },  
        smart: {  
            title: 'Розумний (Smart)',  
            description: 'Інтелектуальний підбір з урахуванням популярності жанрів'  
        },  
        trends: {  
            title: 'Тренди (Популярне)',  
            description: 'Показує тільки популярний контент'  
        },  
        random: {  
            title: 'Один із вибраних (Mix)',  
            description: 'Випадковий вибір одного з обраних жанрів'  
        }  
    };  
    ...
    function getRandomConfig() {  
        ...
        var params = {  
            ...
            'vote_count.gte': 500, // ЗБІЛЬШЕНО для уникнення ноунеймів з рейтингом 10  
            'language': lang,  
            'sort_by': 'popularity.desc',  
            'page': Math.floor(Math.random() * 20) + 1 // ЗБІЛЬШЕНО для різноманітності  
        };  
  
        // ВИПРАВЛЕНО: Проста і надійна логіка фільтрації по роках  
        if (s.years === 'new') {  
                ...
                calls.unshift(function (call) {  
                    ...
                    Lampa.Api.sources.tmdb.get(method, config.params, function (json) {  
                        if (json && json.results) {  
                            ...
                            // Просте сортування за рейтингом  
    ...
    function openSettings() {  
        ...
        // Простий список жанрів БЕЗ папок  
