(function () {  
    ...
    // Додано прапорець для відстеження стану меню  
    var menuAdded = false;  
    ...
    function addMenuItem() {  
        ...
        if (menuList.length) {  
            ...
            menuAdded = true; // Встановлюємо прапорець після успішного додавання  
        }  
    }  
    ...
    function startPlugin() {  
        ...
        Lampa.Listener.follow('app', function (e) {  
            if (e.type === 'ready') {  
                menuAdded = false; // Скидаємо прапорець при оновленні додатку  
                addMenuItem();  
            }  
        });  
    }  
