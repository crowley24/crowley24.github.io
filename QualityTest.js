(function () {
  ...
  // Оновлені іконки з вбудованим SVG (прозорий фон)
  var svgIcons = {
    '4K': 'data:image/svg+xml;charset=utf-8,' + encodeURIComponent('<svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg"><text x="50%" y="45%" dominant-baseline="middle" text-anchor="middle" fill="white" font-family="Arial, sans-serif" font-size="35" font-weight="bold">4K</text><text x="50%" y="75%" dominant-baseline="middle" text-anchor="middle" fill="#E63946" font-family="Arial, sans-serif" font-size="14" font-weight="bold">ULTRA HD</text><path d="M10 90H90" stroke="#E63946" stroke-width="5" stroke-linecap="round"/></svg>'),
    'FULL HD': 'data:image/svg+xml;charset=utf-8,' + encodeURIComponent('<svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg"><text x="50%" y="45%" dominant-baseline="middle" text-anchor="middle" fill="white" font-family="Arial, sans-serif" font-size="24" font-weight="bold">1080P</text><text x="50%" y="75%" dominant-baseline="middle" text-anchor="middle" fill="#00AEEF" font-family="Arial, sans-serif" font-size="16" font-weight="bold">FULL HD</text><path d="M10 90H90" stroke="#00AEEF" stroke-width="5" stroke-linecap="round"/></svg>'),
    'HD': 'data:image/svg+xml;charset=utf-8,' + encodeURIComponent('<svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg"><text x="50%" y="45%" dominant-baseline="middle" text-anchor="middle" fill="white" font-family="Arial, sans-serif" font-size="28" font-weight="bold">720P</text><text x="50%" y="75%" dominant-baseline="middle" text-anchor="middle" fill="#00AEEF" font-family="Arial, sans-serif" font-size="20" font-weight="bold">HD</text><path d="M15 90H85" stroke="#00AEEF" stroke-width="5" stroke-linecap="round"/></svg>'),
    
    // Решта поки залишається через зовнішні посилання
  ...
  var style = '<style>\
    ...
    .card-quality-badge img { filter: drop-shadow(0 1px 3px rgba(0,0,0,0.8)); }\
  </style>';
  $('body').append(style);
