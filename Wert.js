(function() {
    ...
    function applyBaseStyles() {
        ...
        style.textContent = `
            /* Ефект плавного наближення та віддалення */
            ...
            @media screen and (max-width: 480px) {
                ...
                .card--collection .card__img {
                    ...
                    animation: kenBurnsEffect 20s ease-in-out infinite !important;
                        ...
                        if (data.logos && data.logos[0]) {
                            ...
                            if (logo !== '') {
                                e.object.activity.render().find('.full-start-new__title').html(
                                    ...
                                    '<img style="margin-top: 5px; max-height: 125px; position: relative; z-index: 10;" src="' + Lampa.TMDB.image('/t/p/w300' + logo.replace('.svg', '.png')) + '"/>' +
                                    '</div>'
                                );
                            }
                        }
