(function() {
    ...
    // Створюємо налаштування в сховищі за замовчуванням
    ...
    function addSettingsMenu() {
        Lampa.Settings.listener.follow('open', function (e) {
            if (e.name === 'main') {
                var folder = $('<div class="settings-folder selector" data-name="mobile_interface">' +
                ...
                folder.on('hover:enter', function () {
                    Lampa.Settings.create({
                        ...
                        onBack: function() {
                            applyStyles(); // Оновлюємо анімацію при виході
                            Lampa.Settings.main();
                        }
                    });
                });
                $('.settings-main').append(folder);
            }
        });
    }
        ...
        Lampa.Listener.follow('full', function(e) {
            if (window.innerWidth <= 480 && e.type === 'complite') {
                ...
                function render(p) {
                    ...
                    e.object.activity.render().find('.full-start-new__title').html('<img src="'+img+'" style="max-height: 120px; object-fit: contain; position: relative; z-index: 10;">');
                }
            }
        });
    }
