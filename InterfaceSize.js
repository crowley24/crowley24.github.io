(function () {  
  ...
  function init() {
    ...
    Lampa.Params.select('interface_size', {  
      '06': lang_data.settings_param_interface_size_mini,        
      '07': lang_data.settings_param_interface_size_very_small, 
      '08': lang_data.settings_param_interface_size_small,       
      '09': lang_data.settings_param_interface_size_medium,    
      '10': lang_data.settings_param_interface_size_standard,    
      '11': lang_data.settings_param_interface_size_large,     
