...
/* GPU acceleration for Rocktek G2 */
.cas-logo, .cas-ratings-line, .cas-description, .cas-studios-row, .full-start-new__buttons, .full-start__background {
...
.cas-logo img { max-width: 450px; max-height: 180px; filter: drop-shadow(0 0 10px rgba(0,0,0,0.5)); }
