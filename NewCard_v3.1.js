(function () {      
    ...
    function addStyles() {      
        ...
        /* Робимо стандартні кнопки видимими */
        .left-title .full-start__buttons { 
        ...
        .left-title .full-start-new__right { display: flex; align-items: flex-end; justify-content: flex-start; padding-bottom: 5vh; padding-left: 3%; }      
