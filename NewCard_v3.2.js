(function () {
    ...
    function applyStyles() {
        ...
        // Видалено @media screen, тепер працює всюди
        ...
        // Адаптація висоти для ТВ (з 62vh на 70vh для кращого вигляду)
        css += '.full-start-new__poster { position: relative !important; overflow: hidden !important; background: #000; z-index: 1; height: 70vh !important; pointer-events: none !important; } ';
        ...
        // Зменшено від'ємний відступ для кращої сумісності з ТВ пультом
        css += '.full-start-new__right { background: none !important; margin-top: -120px !important; z-index: 2 !important; display: flex !important; flex-direction: column !important; align-items: center !important; padding: 0 10px !important; gap: ' + blocksGap + ' !important; } ';
    ...
    function init() {
        Lampa.Listener.follow('full', function (e) {
            ...
            // Видалено перевірку window.innerWidth, тепер працює на ТВ
    ...
    function startPlugin() {
        ...
        // Примусово вимикаємо розмиття фону для всіх пристроїв
