(function () {    
                    ...
                    <div class="left-title__content">          
                        ...
                        <div class="full-start-new__buttons">          
                            ...
                            <div class="full-start__button selector button--book">          
                                <svg width="21" height="32" viewBox="0 0 21 32" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2 1.5H19C19.2761 1.5Z" stroke="currentColor" stroke-width="2.5"/></svg>  
    ...
    function addStyles() {      
        ...
        .full-start__background { will-change: transform; transform: translateZ(0); transform: scale(1.1); transition: transform 0.8s ease-out; }      
        ...
        .cas-logo, .cas-studios-row, .cas-rate-items, .cas-meta-info, .cas-quality-row, .cas-description, .cas-details-wrapper {      
            ...
            transition: opacity 0.3s ease, transform 0.3s var(--cas-anim-curve);      
        ...
        .full-start-new__buttons {      
            display: flex !important; flex-direction: row !important; gap: 15px; margin-top: 1.2em;    
            opacity: 0; transform: translateY(15px) scale(0.98);      
            transition: opacity 0.3s ease, transform 0.3s cubic-bezier(0.34, 1.56, 0.64, 1);      
        }      
        .cas-animated .full-start-new__buttons { opacity: 1 !important; transform: translateY(0) scale(1); transition-delay: 0.3s; }      
        ...
        .left-title .full-start-new__buttons .full-start__button {      
            ...
            border: 2px solid transparent !important; border-radius: 8px !important; padding: 6px 14px !important;    
        }      
        .left-title .full-start-new__buttons .full-start__button.focus {      
            color: #fff !important; transform: scale(1.05);      
            background: rgba(255,255,255,0.12) !important; border-color: rgba(255,255,255,0.3) !important;      
        }      
        ...
        .left-title .full-start-new__right { display: flex; align-items: flex-end; justify-content: flex-start; padding-bottom: 2vh; padding-left: 2%; }      
    ...
    function startSlideshow(render, backdrops) {      
        ...
        window.casBgInterval = setInterval(() => {      
            ...
            bg.css('opacity', '0');      
            setTimeout(() => { bg.attr('src', nextSrc); bg.css('opacity', '1'); }, 400);      
        }, 15000);      
    }      
    ...
    function attachLoader() {      
        Lampa.Listener.follow('full', (event) => {      
            if (event.type === 'complite') {      
                ...
                // Оптимізований фокус кнопок
                setTimeout(() => {      
                    const btns = render.find('.full-start-new__buttons');
                    const first = btns.find('.selector').first();      
                    if (first.length) {      
                        Lampa.Nav.focus(btns); 
                        btns.find('.selector').removeClass('focus');
    ...
    function startPlugin() {      
        try { initializePlugin(); } catch (e) { console.error('NewCard error:', e); }      
    }      
