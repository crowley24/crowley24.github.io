...
function injectUAStyles(){    
    ...
    var css = ""    
    + ".full-start__buttons{display:flex!important;flex-direction:row!important}"    
    + ".full-start__button.playua-btn{order:-999!important;background:#333!important;color:#fff!important;border:0!important;outline:0!important;box-shadow:0 2px 8px rgba(0,0,0,.28)!important}"    
...
function attachButtonOnce(root, ev) {    
    ...
    // Повернутися до append(), але з CSS order:-999    
...
var aDV = /dolby\s*vision|dovi|\bDV\b/i.test(a.title);  
  ...
  function makeButton(){  
  var $ = window.$ || window.jQuery;  
  return $('<div class="full-start__button selector playua-btn" data-playua-icon="1" tabindex="0" aria-label="UaDV">'  
