...
function pluginPage(object) {
    ...
    title: '', // Очищаємо стандартну назву знизу
    release_year: ''
});

// Вставляємо назву всередину рядка
