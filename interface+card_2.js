    ...
    class InterfaceInfo {  
        ...
        update() {  
            ...
            if (details) {  
                ...
                if (this.object.countries && this.object.countries.length > 0) {  
                    detailsHtml += '<div>' + this.object.countries.join(', ') + '</div>';  
                }  
                  
                if (this.object.genres && this.object.genres.length > 0) {  
                    detailsHtml += '<div>' + this.object.genres.join(', ') + '</div>';  
                }  
