...
(function () {  
  ...
  function processCards() {  
    $('.card:not(.quality-processed)').each(function() {  
      ...
      if (movie && (movie.title || movie.name)) {  
        // Якщо парсер активований, використовуємо його  
        if (typeof Lampa !== 'undefined' && Lampa.Storage && Lampa.Storage.field('parser_use')) {  
          ...
          // Якщо парсер не активований, додаємо тестовий бейдж  
          var testBadge = '<div class="card-quality-badges"><div class="card-quality-badge" style="background: #ff6b6b; color: white; padding: 2px 4px; font-size: 8px;">TEST</div></div>';  
  ...
  console.log('[QualityBadges] Plugin loaded successfully');  
