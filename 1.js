(function () {              
    ...
    :root { --cas-logo-scale: 1; --cas-blocks-gap: 30px; --cas-meta-size: 1.3em; --cas-anim-curve: cubic-bezier(0.2, 0.8, 0.2, 1); } [1](#26-0)   
    ...
    .cas-quality-row {                 
        ...
        align-items: center;                 
        gap: 8px;                 
        margin-bottom: calc(var(--cas-blocks-gap) * 0.4);                 
    }                
    ...
    .cas-meta-info {                 
        ...
        gap: 8px;                 
        font-weight: 400;                 
        margin-bottom: calc(var(--cas-blocks-gap) * 0.3);                 
    }                
