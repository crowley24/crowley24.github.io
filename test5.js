(function () {
    ...
    function applyStyles() {
        ...
        css += '@keyframes wave_cascade { 0% { opacity: 0; transform: scale(0.8) translateY(8px); } 100% { opacity: 1; transform: scale(1) translateY(0); } } ';
        ...
        var uiAnimClass = isUIAnim ? 'animation: ' + chosenAnimName + ' 0.7s ' + animTiming + ' forwards; opacity: 0; will-change: transform, opacity; transform: translateZ(0); ' : '';
        ...
        css += '.studio-header-brand { ' + uiAnimClass + ' animation-delay: 0.06s; order: 1; width: 100%; display: flex; justify-content: flex-start; align-items: center; margin-bottom: -2px !important; } ';
        ...
        css += '.full-start-new__title { ' + uiAnimClass + ' animation-delay: 0.12s; width: 100% !important; display: flex !important; justify-content: flex-start !important; align-items: center !important; margin: 0 !important; min-height: 50px; order: 2; overflow: visible !important; } ';
        ...
        css += '.full-start-new__tagline { ' + uiAnimClass + ' animation-delay: 0.18s; display: ' + (showTagline ? 'block' : 'none') + ' !important; font-style: italic !important; font-size: 1em !important; margin: 0 !important; color: rgba(255,255,255,0.8) !important; text-align: left !important; order: 3; } ';
        
        css += '.plugin-meta-row { ' + uiAnimClass + ' animation-delay: 0.24s; display: flex; justify-content: flex-start; align-items: center; flex-wrap: nowrap; gap: 10px; margin: 0 !important; font-size: calc(' + rSize + ' * 2.8); width: 100%; order: 4; color: rgba(255,255,255,0.85); font-family: "Inter", -apple-system, system-ui, sans-serif; } ';
        ...
        if (isUIAnim) {
            ...
            if (badgeAnim !== 'none') {
                ...
                css += '; animation-delay: calc(0.3s + (var(--item-index) * 0.06s)), calc(0.9s + (var(--item-index) * 0.1s))';
            } else {
                css += '; animation-delay: calc(0.3s + (var(--item-index) * 0.06s))';
            }
