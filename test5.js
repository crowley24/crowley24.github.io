(function () {
    ...
    function applyStyles() {
        ...
        /* Обгортка .card-tweaks__buttons під постером на всю ширину */
        css += '.card-tweaks__buttons { ' + uiAnimClass + ' animation-delay: 0.35s; width: 100% !important; display: flex !important; justify-content: flex-start !important; align-items: center !important; gap: 15px !important; margin-top: 15px !important; order: 5; } ';
        css += '.card-tweaks__buttons .full-start__button { background: rgba(255,255,255,0.08) !important; border: 2px solid transparent !important; border-radius: 8px !important; box-shadow: none !important; display: flex !important; flex-direction: row !important; align-items: center !important; gap: 8px !important; padding: 10px 16px !important; transition: transform 0.2s ease, background 0.2s ease, border-color 0.2s ease; } ';
        css += '.card-tweaks__buttons .full-start__button.focus { background: rgba(255,255,255,0.25) !important; border-color: #fff !important; transform: scale(1.05); } ';
        css += '.card-tweaks__buttons .full-start__button svg, .card-tweaks__buttons .full-start__button img { width: 22px !important; height: 22px !important; margin-bottom: 0 !important; fill: #fff !important; filter: drop-shadow(0 2px 8px rgba(0,0,0,0.5)); } ';
        css += '.card-tweaks__buttons .full-start__button span { font-size: 11px !important; text-transform: uppercase !important; opacity: 0.9 !important; font-weight: 600; letter-spacing: 0.05em; } ';
