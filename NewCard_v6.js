(function () {    
    ...
    function addStyles() {    
        ...
        <style>  
            ...
            /* Прибираємо стандартні класи body */  
            body.applecation--active {  
                background: #000 !important;  
            }  
  
            /* Вимикаємо стандартні ефекти затемнення */  
            ...
            /* Мінімалістичні іконки без круглих фонів */  
            ...
            .button--play.focus {   
                ...
                filter: none !important; /* Для головної кнопки світіння не робимо, тільки зміна кольору */  
            }  
