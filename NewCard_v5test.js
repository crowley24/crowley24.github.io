(function () {  
    ...
    function applySettings() {  
        ...
        if (currentCard.length > 0) {  
            ...
            if (Lampa.Storage.get('cas_slideshow_enabled') && !performanceMode) {  
    ...
    function addStyles() {  
        ...
        body.cas--performance-mode * { transition: none !important; animation: none !important; }  
        body.cas--performance-mode .cas-logo, body.cas--performance-mode .cas-description, body.cas--performance-mode .cas-meta-info, body.cas--performance-mode .cas-details-wrapper { opacity: 1 !important; transform: none !important; }  
        .cas-logo, .cas-description, .cas-meta-info, .cas-details-wrapper { opacity: 0 !important; transform: translateY(10px); transition: opacity 0.4s var(--cas-anim-curve), transform 0.4s var(--cas-anim-curve); will-change: opacity, transform; }  
        .cas-animated .cas-logo { opacity: 1 !important; transform: translateY(0); transition-delay: 0.05s; }  
        .cas-studio-item { opacity: 0 !important; transform: translateX(-15px); transition: all 0.3s var(--cas-anim-curve); will-change: opacity, transform; }  
        ...
        .cas-rate-item { opacity: 0 !important; transform: translateX(-12px); transition: all 0.3s var(--cas-anim-curve); will-change: opacity, transform; }  
        ...
        .cas-quality-item, .cas-sep { opacity: 0 !important; transform: translateX(-12px); transition: all 0.3s var(--cas-anim-curve); will-change: opacity, transform; }  
        ...
        .full-start-new__buttons { opacity: 0 !important; transform: translateY(10px); transition: all 0.3s var(--cas-anim-curve); will-change: opacity, transform; }  
        .cas-animated .full-start-new__buttons { opacity: 1 !important; transform: translateY(0); transition-delay: 0.65s; }  
        .cas-logo img { background: transparent !important; border: none !important; padding: 0 !important; box-shadow: none !important; max-width: 450px; max-height: 180px; transform: scale(var(--cas-logo-scale)); transform-origin: left bottom; will-change: transform; backface-visibility: hidden; }  
        .cas-studio-item img { height: 18px; filter: drop-shadow(0 0 2px rgba(255,255,255,0.8)) drop-shadow(0 0 4px rgba(255,255,255,0.6)); opacity: 0.9; will-change: opacity; }  
        ...
        .cas-quality-item img { height: 15px; will-change: opacity; }  
        .left-title .full-start-new__buttons { margin-top: 1.2em; display: flex; gap: 20px; }  
        .left-title .full-start-new__buttons .full-start__button { background: transparent !important; color: rgba(255,255,255,0.6) !important; display: flex; align-items: center; gap: 10px; transition: all 0.15s ease-out; will-change: transform, color; }  
        .left-title .full-start-new__buttons .full-start__button.focus { color: #fff !important; transform: scale(1.05); }  
