(function () {
    ...
    // ----------------------------------------------------
    // 2. CSS-СТИЛІ ТЕМИ (ВКЛЮЧЕНО ПРЕФІКСИ -WEBKIT-)
    // ----------------------------------------------------
    ...
    const THEME_CSS = `
        ...
        .player-panel .button.focus {
            ...
            -webkit-animation: night-pulse 2s infinite; /* FIX */
            animation: night-pulse 2s infinite; 
        }
        
        /* Використовуємо -webkit-keyframes для кращої сумісності */
        @-webkit-keyframes night-pulse {
            0% { -webkit-box-shadow: 0 0 20px rgba(233, 64, 87, 0.3); box-shadow: 0 0 20px rgba(233, 64, 87, 0.3); }
            50% { -webkit-box-shadow: 0 0 30px rgba(242, 113, 33, 0.3); box-shadow: 0 0 30px rgba(242, 113, 33, 0.3); }
            100% { -webkit-box-shadow: 0 0 20px rgba(138, 35, 135, 0.3); box-shadow: 0 0 20px rgba(138, 35, 135, 0.3); }
        }
        ...
        /* Також додаємо префікси для тіней карток, якщо потрібно */
        .card.focus .card__view::after,
        .card.hover .card__view::after {
            border: 2px solid #e94057;
            -webkit-box-shadow: 0 0 30px rgba(242, 113, 33, 0.5); /* FIX */
        ...
        .modal__content {
            ...
            -webkit-box-shadow: 0 0 30px rgba(242, 113, 33, 0.1); /* FIX */
            box-shadow: 0 0 30px rgba(242, 113, 33, 0.1);
        }
    `;

    // ----------------------------------------------------
    // 3. ІНІЦІАЛІЗАЦІЯ (Використовуємо try...catch)
    // ----------------------------------------------------
    ...
    function registerTheme() {
        ...
        } catch(e) { console.error('Error adding settings component:', e); }
        ...
        } catch(e) { console.error('Error registering theme CSS:', e); }
