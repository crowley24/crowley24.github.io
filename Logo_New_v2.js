!function() {  
    ...
    window.logoplugin || function() {  
        ...
        function o(e, t, n, i) {  
            t && (t.style.height = "", t.style.overflow = "", t.style.display = "", t.style.transition = "none", t.style.boxSizing = "");  
            e.style.marginTop = "0";  
        ...
        // Слухач події для повного екрану  
                            ...
                            p.onload = function() {  
                                setTimeout((function() {  
                                    ...
                                    "js" === a ? (  
                                        ...
                                        i(d, 1, 0, e, (function() {  
                                            r.empty(), r.append(p), r.css({ opacity: "1", transition: "none" });  
