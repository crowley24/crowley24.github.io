(function () {
    ...
    var collectionsConfig = [
        ...
        // 🎬 Cult 80–90 (clean version)
        {
            id: 'cult_80_90_premium',
            emoji: '📼',
            name_key: 'tmdb_mod_c_cult_80_90',
            request: 'discover/movie?primary_release_date.gte=1980-01-01&primary_release_date.lte=1999-12-31&sort_by=popularity.desc&vote_average.gte=7&vote_count.gte=1000'
        },
        ...
        // 👻 Horror Premium
        {
            id: 'horror_premium',
            emoji: '👻',
            name_key: 'tmdb_mod_c_horror_premium',
            request: 'discover/movie?with_genres=27&sort_by=vote_average.desc&vote_average.gte=6.2&vote_count.gte=300&with_runtime.gte=70'
        }
    ];
    ...
    Lampa.Lang.add({
        ...
        // ===== OLD COLLECTIONS =====
        tmdb_mod_plugin_name: { ru: "Главная страница +", uk: "Головна сторінка +" },
        ...
        // ===== NEW PREMIUM =====
        tmdb_mod_c_cult_80_90: { ru: "Хиты 80–90 (культовые)", uk: "Хіти 80–90 (культові)" },
        tmdb_mod_c_horror_premium: { ru: "Ужасы Premium", uk: "Жахи Premium" }
    });
    }
    ...
    function addSettings() {
        ...
        Lampa.SettingsApi.addComponent({
            ...
            icon: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="7"></rect></svg>'
        });
        ...
        collectionsConfig.forEach(function (cfg, index) {
            ...
            Lampa.SettingsApi.addParam({
                ...
                field: { name: '<span style="opacity:0.5">↳ Порядок</span>' },
                onChange: function (value) {
