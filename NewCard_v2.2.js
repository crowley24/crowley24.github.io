(function () {  
    'use strict';  
      ...
      function addSettings() {  
          ...
          // Додано onChange для всіх trigger параметрів  
          Lampa.SettingsApi.addParam({   
              component: PLUGIN_ID,   
      ...
      function applySettings() {  
         ...
         root.style.setProperty('--cas-meta-size', metaSize + 'em');  
          ...
          // Оновлюємо поточну відкриту картку, якщо вона є  
             ...
             // Оновлюємо слайд-шоу та анімацію  
              ...
              if (Lampa.Storage.get('cas_slideshow_enabled')) {  
                  ...
                  if (bg.length && bg.attr('src')) {  
                      // Отримуємо дані про фони з кешу або API  
  ...
  .left-title .full-start-new__buttons .full-start__button.focus {  
      color: #fff !important; transform: scale(1.15) translateZ(0); filter: drop-shadow(0 0 12px rgba(255,255,255,0.6));  
  }  
