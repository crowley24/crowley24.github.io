...
:root{
    ...
    --cas-blocks-gap:20px;
    --cas-meta-size:1.3em;
    --cas-curve-slide:cubic-bezier(.25,1,.5,1);
    --cas-curve-spring:cubic-bezier(.175,.885,.32,1.275)
}
.full-start__background{
    height:calc(100% + 6em);
    left:0!important;
    opacity:0!important;
    transition:opacity 1s cubic-bezier(.2,.8,.2,1)!important;
    will-change:opacity;
    overflow:hidden!important;
    transform:translateZ(0)
}
.full-start__background.loaded{opacity:1!important}
.full-start__background.dim{opacity:.35!important}

@keyframes casKenBurnsParallax{
    0%,100%{transform:scale(1.02) translateY(0) translateX(0) translateZ(0)}
...
@keyframes casDynamicTiltZoom{
    0%,100%{transform:scale(1.08) rotate(0) translate3d(0,0,0)}
...
.cas-logo,.cas-tagline,.cas-studios-row,.cas-rate-items,
.cas-meta-info,.cas-quality-row,.cas-description,
.cas-details-wrapper,.full-start-new__buttons,.cas-bottom-ratings{
    opacity:0!important;
...
.cas-quality-row.show-quality .cas-quality-item:nth-child(1){transition-delay:0s}
.cas-quality-row.show-quality .cas-quality-item:nth-child(2){transition-delay:.05s}
.cas-quality-row.show-quality .cas-quality-item:nth-child(3){transition-delay:.10s}
.cas-quality-row.show-quality .cas-quality-item:nth-child(4){transition-delay:.15s}
.cas-quality-row.show-quality .cas-quality-item:nth-child(5){transition-delay:.20s}

.cas-anim-slide .cas-logo,.cas-anim-slide .cas-tagline,
.cas-anim-slide .cas-studios-row,.cas-anim-slide .cas-rate-items,
.cas-anim-slide .cas-meta-info,.cas-anim-slide .cas-quality-row,
.cas-anim-slide .cas-description,.cas-anim-slide .cas-details-wrapper,
.cas-anim-slide .full-start-new__buttons,.cas-anim-slide .cas-bottom-ratings{
    transform:translate3d(0,8px,0);
    transition:opacity .35s var(--cas-curve-slide),
...
.cas-anim-slide.cas-animated .cas-logo{transition-delay:0s}
.cas-anim-slide.cas-animated .cas-studios-row{opacity:.9!important;transition-delay:.03s}
.cas-anim-slide.cas-animated .cas-tagline{opacity:.85!important;transition-delay:.06s}
.cas-anim-slide.cas-animated .cas-meta-info{opacity:.85!important;transition-delay:.09s}
.cas-anim-slide.cas-animated .cas-description{opacity:.75!important;transition-delay:.12s}
.cas-anim-slide.cas-animated .full-start-new__buttons,
.cas-anim-slide.cas-animated .cas-bottom-ratings{transition-delay:.16s}
.cas-anim-slide.cas-animated .cas-quality-row{transition-delay:.18s}

.cas-anim-spring .cas-logo,.cas-anim-spring .cas-tagline,
.cas-anim-spring .cas-studios-row,.cas-anim-spring .cas-rate-items,
.cas-anim-spring .cas-meta-info,.cas-anim-spring .cas-quality-row,
.cas-anim-spring .cas-description,.cas-anim-spring .cas-details-wrapper,
.cas-anim-spring .full-start-new__buttons,.cas-anim-spring .cas-bottom-ratings{
...
.cas-anim-spring.cas-animated .cas-logo{transition-delay:0s}
.cas-anim-spring.cas-animated .cas-studios-row{opacity:.9!important;transition-delay:.03s}
.cas-anim-spring.cas-animated .cas-tagline{opacity:.85!important;transition-delay:.06s}
.cas-anim-spring.cas-animated .cas-meta-info{opacity:.85!important;transition-delay:.09s}
.cas-anim-spring.cas-animated .cas-description{opacity:.75!important;transition-delay:.12s}
.cas-anim-spring.cas-animated .full-start-new__buttons,
.cas-anim-spring.cas-animated .cas-bottom-ratings{transition-delay:.16s}
.cas-anim-spring.cas-animated .cas-quality-row{transition-delay:.18s}
...
.cas-ratings-line,.cas-meta-info,.cas-quality-row,
.full-start-new__buttons,.cas-studios-row{
    display:flex;
    align-items:center
}
.cas-ratings-line{
...
.cas-sep{margin:0 2px!important}
.cas-studios-row{
    flex-wrap:wrap;
    justify-content:flex-start!important;
    gap:8px
...
.cas-audio-item{
    ...
    function getCachedData(id) {
        ...
        const item = cache[id];
        return item && Date.now() - item.time < CACHE_LIFETIME
            ? item.data
            : null;
    }
    ...
    function cleanup() {
        stopSlideshow();
        $('.left-title__content').parent().parent()
    ...
    function startSlideshow(render, backdrops, currentLang) {
        ...
        const lang = [], none = [], other = [];

        backdrops.forEach(b => {
            const l = b.iso_639_1;
            if (l === currentLang) lang.push(b);
            else if (!l || l === 'xx' || l === 'null') none.push(b);
            else other.push(b);
        });

        let list = none.slice();

        if (list.length < 3 && lang.length) {
            list = list.concat(lang);
        }

        if (list.length < 3 && other.length) {
            other.sort(
        ...
        currentInterval = setInterval(() => {
            ...
            const nextSrc = Lampa.TMDB.image(
                '/t/p/original' + list[index].file_path
            );
