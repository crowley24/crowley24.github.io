...
(function () {
  ...
  // const TV_SVG = `<svg><use xlink:href="#sprite-tv"></use></svg>`; // Видалено
  // const ANIME_SVG = `<svg><use xlink:href="#sprite-anime"></use></svg>`; // Видалено
  
  // Додано нові іконки для Вибраного та Історії
  ...
  function init(){
    ...
    // addItem('tv', TV_SVG); // Видалено
    // addItem('anime', ANIME_SVG); // Видалено

    // Додано нові кнопки
    addItem('favourites', FAVORITE_SVG); 
