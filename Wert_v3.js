(function () {
    ...
    // 1. Ініціалізація налаштувань (БЕЗ ЗМІН)
    var settings_list = [
    ...
    // 2. Стилі (РЕДАГОВАНО ТІЛЬКИ ВІЗУАЛ РЕЙТИНГІВ)
    function applyStyles() {
        ...
        css += '.full-start-new__title { width: 100%; display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 70px; margin-bottom: 10px; } ';
        css += '.full-start-new__title img { max-height: 110px; object-fit: contain; } ';
        ...
        // ПРЕМІАЛЬНІ ПІГУЛКИ (КОМПАКТНІ)
        css += '.full-start-new__rating { display: flex !important; gap: 8px !important; margin: 12px 0 !important; border: none !important; padding: 0 !important; } ';
        css += '.full-start-new__rating > div { display: flex !important; align-items: center !important; padding: 4px 10px !important; border-radius: 8px !important; background: rgba(255, 255, 255, 0.1) !important; border: 1px solid rgba(255,255,255,0.15) !important; font-weight: 700 !important; font-size: 13px !important; color: #fff !important; width: auto !important; height: auto !important; margin: 0 !important; } ';
        css += '.full-start-new__rating .tmdb { border-color: rgba(1, 210, 119, 0.4) !important; color: #01d277 !important; } ';
        ...
        css += '.full-start-new__rating .imdb { border-color: rgba(245, 197, 24, 0.4) !important; color: #f5c518 !important; } ';
    ...
    // 6. Логіка завантаження Лого фільму, Рейтингів та Якості (БЕЗ ЗМІН ФУНКЦІОНАЛУ)
