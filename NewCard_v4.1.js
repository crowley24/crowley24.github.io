            ...
            <div class="full-start-new__body">            
                ...
                <div class="full-start-new__right">            
                    <div class="left-title__content">            
                        ...
                        <!-- Стандартний контейнер кнопок Lampa -->        
...
<path d="M2 1.5H19C19.2761 1.5Z" stroke="currentColor" stroke-width="2.5"/>      
    ...
    function addStyles() {        
        ...
        /* Видаляємо кастомні стилі для кнопок, щоб використовувати стандартні */        
    ...
    function attachLoader() {      
        Lampa.Listener.follow('full', (event) => {      
            if (event.type === 'complite') {      
                ...
                setTimeout(() => {      
                    // Фокус на першу кнопку зі стандартного контейнера      
                    const firstButton = render.find('.full-start__buttons .full-start__button').first();      
