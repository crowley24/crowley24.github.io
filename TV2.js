...
function prepareUrl(url, epg) {  
	// Проста підготовка URL без складних шаблонів  
	return url;  
}  
...
function pluginPage(object) {  
	...
	function epgUpdateData(epgId) {  
		// Спрощена функція оновлення EPG  
	}  
	...
	this.append = function (data) {  
		...
		data.forEach(function (channel) {  
			...
			img.onerror = function (e) {  
				// Створення простого текстового логотипа  
	...
	this.pause = function () {  
		// Пауза не потрібна для мінімалістичної версії  
	};  
	  
	this.stop = function () {  
		// Зупинка не потрібна для мінімалістичної версії  
	};  
