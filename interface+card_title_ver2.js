(function () {  
    ...
    function shouldUseNewInterface(object) {  
        ...
        // Видалено перевірку преміум акаунту  
        return true;  
    }  
    ...
    class InterfaceInfo {  
        ...
        draw(movie) {  
            ...
            if (movie.runtime) details.push(Lampa.Utils.secondsTime(movie.runtime * 60, true));  
    ...
    // Запуск V3 версії для Lampa >= 300  
    if (Lampa.Manifest.app_digital >= 300) {  
        startPluginV3();  
        return;  
    }  
  
    // Legacy версія для Lampa 153-299  
