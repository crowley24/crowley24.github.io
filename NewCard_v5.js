(function () {  
    ...
    function startSlideshow($poster, backdrops) {  
        ...
        slideshowTimer = setInterval(() => {  
            ...
            const $cur = $poster.find('img').first();  
...
/* Якість */  
.applecation__quality-row { display: flex; align-items: center; gap: 8px; margin-bottom: 0.5em; opacity: 0; transform: translateY(10px); transition: opacity 0.4s ease, transform 0.4s ease; }  
    ...
    function loadLogo(event) {  
        ...
        $.get(apiUrl, imagesData => {  
            ...
            if (imagesData.backdrops && imagesData.backdrops.length > 1) {  
                startSlideshow(render.find('.full-start-new__poster'), imagesData.backdrops.slice(0, 15));  
            }  
