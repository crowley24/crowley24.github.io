...
        { id: 'mobile_interface_slideshow_quality', default: 'w780' } // ДОДАНО: Якість слайд-шоу
    ];
...
        var quality = Lampa.Storage.get('mobile_interface_slideshow_quality', 'w780'); // ВИКОРИСТОВУЄМО ВИБРАНУ ЯКІСТЬ
...
        // ДОДАНО: Налаштування вибору якості слайд-шоу
        Lampa.SettingsApi.addParam({
            component: 'mobile_interface',
            param: { 
                name: 'mobile_interface_slideshow_quality', 
                type: 'select', 
                values: { 'w300': 'Низька (w300)', 'w780': 'Середня (w780)', 'w1280': 'Висока (w1280)', 'original': 'Оригінальна' }, 
                default: 'w780' 
            },
            field: { name: 'Якість слайд-шоу', description: 'Розмір зображень фону' }
        });
