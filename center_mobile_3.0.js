(function() {  
  ...
  function centerInterface() {  
    ...
    if (isMobile) {  
      ...
      css += '.full-descr__details, .full-descr__tags { display: flex !important; flex-direction: column !important; justify-content: center !important; align-items: center !important; }';  
