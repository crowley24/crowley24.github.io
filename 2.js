...
function addStyles() {    
    ...
    /* Хвильові анімації для окремих елементів метаданих */  
    .cas-wave-studio { opacity: 0; transform: translateY(10px); transition: all 0.4s var(--cas-anim-curve); }  
    .cas-wave-year { opacity: 0; transform: translateY(10px); transition: all 0.4s var(--cas-anim-curve); }  
    .cas-wave-time { opacity: 0; transform: translateY(10px); transition: all 0.4s var(--cas-anim-curve); }  
    .cas-wave-genre { opacity: 0; transform: translateY(10px); transition: all 0.4s var(--cas-anim-curve); }  
    .cas-wave-rating { opacity: 0; transform: translateY(10px); transition: all 0.4s var(--cas-anim-curve); }  
    .cas-wave-quality { opacity: 0; transform: translateY(10px); transition: all 0.4s var(--cas-anim-curve); }  
    .cas-wave-hdr { opacity: 0; transform: translateY(10px); transition: all 0.4s var(--cas-anim-curve); }  
    .cas-wave-ukr { opacity: 0; transform: translateY(10px); transition: all 0.4s var(--cas-anim-curve); }  
  
    /* Послідовні затримки для хвильового ефекту */  
    .cas-animated .cas-wave-studio { opacity: 0.9; transform: translateY(0); transition-delay: 0.1s; }  
    .cas-animated .cas-wave-year { opacity: 0.7; transform: translateY(0); transition-delay: 0.2s; }  
    .cas-animated .cas-wave-time { opacity: 0.7; transform: translateY(0); transition-delay: 0.3s; }  
    .cas-animated .cas-wave-genre { opacity: 0.7; transform: translateY(0); transition-delay: 0.4s; }  
    .cas-animated .cas-wave-rating { opacity: 1; transform: translateY(0); transition-delay: 0.5s; }  
    .cas-animated .cas-wave-quality { opacity: 0.9; transform: translateY(0); transition-delay: 0.6s; }  
    .cas-animated .cas-wave-hdr { opacity: 0.9; transform: translateY(0); transition-delay: 0.7s; }  
    .cas-animated .cas-wave-ukr { opacity: 0.9; transform: translateY(0); transition-delay: 0.8s; }  
