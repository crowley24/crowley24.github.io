...
this.build = function (catalog) {  
    ...
    Lampa.Controller.add('content', {  
        ...
        left: function left() {  
            // Перевіряємо, чи фокус вже на групах  
            if (Navigator.canmove('left') && !$(Navigator.focused()).hasClass(plugin.component + '__group-item')) {  
                Navigator.move('left');  
            } else if (!$(Navigator.focused()).hasClass(plugin.component + '__group-item')) {  
                // Переміщуємо фокус на панель груп  
        ...
        right: function right() {  
            if ($(Navigator.focused()).hasClass(plugin.component + '__group-item')) {  
                // Повертаємо фокус на канали  
                Lampa.Controller.collectionSet(scroll.render());  
                Lampa.Controller.collectionFocus(last || false, scroll.render());  
