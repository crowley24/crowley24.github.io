(function () {  
  ...
  var Player = /*#__PURE__*/function () {  
    ...
    _createClass(Player, [{  
      ...
      key: "toggleMute",  // <-- ДОДАНО ДЛЯ КНОПКИ MUTE  
  ...
  function startPlugin() {  
    ...
    Lampa.Lang.add({  
      ...
      cardify_trailer_mute: {  // <-- ДОДАНО ДЛЯ КНОПКИ MUTE  
        ru: 'Звук трейлера',  
        en: 'Trailer sound',  
        uk: 'Звук трейлера',  
        be: 'Гук трэйлера',  
