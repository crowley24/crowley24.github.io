(function () {  
    ...
    function addTranslations() {  
        ...
        Lampa.Lang.add({  
            tmdb_mod_plugin_name: { ru: "Подборки TMDB_MOD", uk: "Підбірки TMDB_MOD" },  
            tmdb_mod_toggle_name: { ru: "Включить TMDB_MOD подборки", uk: "Увімкнути TMDB_MOD підбірки" },  
            tmdb_mod_toggle_desc: { ru: "Показывать кастомные подборки на главной странице", uk: "Показувати кастомні підбірки на головній сторінці" },  
            ...
            tmdb_mod_c_cult: { ru: "Популярные фильмы с 80-х", uk: "Популярні фільми з 80-х" },  
            tmdb_mod_c_top_studios: { ru: "Золотая Десятка Студий", uk: "Золота Десятка Студій" },  
            tmdb_mod_c_best_current_y: { ru: "Лучшие фильмы " + currentYear + " года", uk: "Кращі фільми " + currentYear + " року" },  
            tmdb_mod_c_best_last_y: { ru: "Лучшие фильмы " + lastYear + " года", uk: "Кращі фільми " + lastYear + " року" },  
            ...
            tmdb_mod_c_miniseries: { ru: "Лучшие Мини-сериалы", uk: "Кращі Міні-серіали" }  
        });  
    }  
    ...
    function addSettings() {    
        ...
        Lampa.SettingsApi.addParam({    
            ...
            field: {     
                ...
                description: Lampa.Lang.translate('tmdb_mod_poster_desc')     
            },    
            onChange: function (value) {    
                pluginSettings.poster_type = value;    
                saveSettings();    
                Lampa.Noty.show(Lampa.Lang.translate('tmdb_mod_noty_reload'));    
            }    
        });  
