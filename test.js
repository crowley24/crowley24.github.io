...
function modifyCardifyStyles() {    
  ...
  style.textContent = `    
    /* Трейлер у правому верхньому куті */  
    ...
    /* ДОДАНО: Примусово зберегти видимість картки фільму */  
    .full-start-new,  
  ...
  console.log('[Cardify Compact] Стилі застосовано (картка залишається видимою)');    
}
