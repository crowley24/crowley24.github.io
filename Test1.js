(function () {                
    ...
    function applySettings() {          
        ...
        if (currentCard.length > 0) {          
            ...
            currentCard.find('.cas-meta-info').toggle(!!Lampa.Storage.get('cas_show_rating'));          
                        
            const hasVisibleElements = currentCard.find('.cas-studios-row:visible, .cas-meta-info:visible, .cas-quality-row:visible, .cas-description:visible').length > 0;          
            ...
            <div class="full-start-new__body">                      
                ...
                <div class="full-start-new__right">                      
                    <div class="left-title__content">                      
                        <!-- Логотип студії зверху -->
                        <div class="cas-studios-row" style="display: flex; gap: 8px; align-items: center; margin-bottom: 12px;"></div>

                        <div class="cas-logo-container" style="margin-bottom: calc(var(--cas-blocks-gap) * 1.5);">                    
                            <div class="cas-logo"></div>                    
                        </div>                    

                        <!-- Метадані, рейтинги, якість та дубляж в одному блоці нижче -->
...
function addStyles() {  
    ...
    .cas-meta-info { display: flex; align-items: center; gap: 8px; font-weight: 400; font-size: var(--cas-meta-size); }    
