(function () {
    ...
    function addStyles() {
        ...
        /* * >>> ФІКС КОНТРАСТУ: Стилі для світлої теми
         */
        ...
        body.light--version .new-interface-info__details,
        body.light--version .new-interface-info__description {
            color: #111; /* Встановлюємо темний колір тексту */
            text-shadow: none; /* Видаляємо темну тінь */
        }
        ...
        /* Кінець блоку фіксів для світлої теми */
    ...
    function displayLogoInFullView(e, logoPath){
        if(logoPath != ''){
            // Додаємо тінь/градієнт, якщо потрібно, або покладаємося на стандартний інтерфейс Lampa
